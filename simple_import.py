...
def get_access_token():
    ...
    auth_data = {"clientId": client_id, "secret": client_secret}
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if isinstance(collections, list) and collections:
                ...
                print(
                    "❌ No collections found in API response. Attempting to create a new collection..."
                )
                ...
                try:
                    create_resp = httpx.post(
                        create_url, json=collection_payload, headers=headers
                    )
                    ...
                    if create_resp.status_code in [200, 201]:
                        ...
                        if collection_id:
                            ...
                            print(
                                "❌ Could not parse collectionId from create response."
                            )
                            return None
                    else:
